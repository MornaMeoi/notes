...
lecturer: Владимиров
lecture: 4
title: "RAII и перемещение"
status: todo
reread:
concepts: ["[[RAII]]", "[[Rule of Five]]"]
---
...
> [!abstract]- Оглавление
> - [[#Владение ресурсом и RAII|Владение ресурсом и RAII]]
>     - [[#Владение ресурсом и RAII#Владение ресурсом|Владение ресурсом]]
>     - [[#Владение ресурсом и RAII#Забавный пример|Забавный пример]]
>     - [[#Владение ресурсом и RAII#Страшное goto|Страшное goto]]
>     - [[#Владение ресурсом и RAII#Социально-приемлимое goto|Социально-приемлимое goto]]
>     - [[#Владение ресурсом и RAII#Отступление: goto considered harmful|Отступление: goto considered harmful]]
>     - [[#Владение ресурсом и RAII#RAII: resource acquisition is initialization|RAII: resource acquisition is initialization]]
>     - [[#Владение ресурсом и RAII#RAII обёртка|RAII обёртка]]
>     - [[#Владение ресурсом и RAII#Глубокое копирование|Глубокое копирование]]
>     - [[#Владение ресурсом и RAII#Доступ к состоянию|Доступ к состоянию]]
>     - [[#Владение ресурсом и RAII#Перегрузка разыменования|Перегрузка разыменования]]
>     - [[#Владение ресурсом и RAII#Проблема со стрелочкой|Проблема со стрелочкой]]
>     - [[#Владение ресурсом и RAII#Решение: drill down|Решение: drill down]]
> - [[#Семантика перемещения|Семантика перемещения]]
>     - [[#Семантика перемещения#Кросс-связывание|Кросс-связывание]]
>     - [[#Семантика перемещения#Обсуждение: методы над rvalues|Обсуждение: методы над rvalues]]
>     - [[#Семантика перемещения#Аннотация методов|Аннотация методов]]
>     - [[#Семантика перемещения#Аккуратнее с возвратом правых ссылок|Аккуратнее с возвратом правых ссылок]]
>     - [[#Семантика перемещения#Перемещающие конструкторы|Перемещающие конструкторы]]
>     - [[#Семантика перемещения#Перемещающее присваивание|Перемещающее присваивание]]
>     - [[#Семантика перемещения#Эффективный обмен значениями|Эффективный обмен значениями]]
>     - [[#Семантика перемещения#Аккуратнее с move on result|Аккуратнее с move on result]]
>     - [[#Семантика перемещения#Задача: особенности move|Задача: особенности move]]
>     - [[#Семантика перемещения#Решение: особенности move|Решение: особенности move]]
>     - [[#Семантика перемещения#Проблема implicit move|Проблема implicit move]]
>     - [[#Семантика перемещения#Правило пяти|Правило пяти]]
>     - [[#Семантика перемещения#Правило нуля|Правило нуля]]
>     - [[#Семантика перемещения#Краевой случай: move from const|Краевой случай: move from const]]
> - [[#Двумерные массивы|Двумерные массивы]]
>     - [[#Двумерные массивы#Row-major vs column-major|Row-major vs column-major]]
>     - [[#Двумерные массивы#Двумерные массивы: jagged arrays|Двумерные массивы: jagged arrays]]
>     - [[#Двумерные массивы#Двумерные массивы|Двумерные массивы]]
>     - [[#Двумерные массивы#Вычисление адресов|Вычисление адресов]]
>     - [[#Двумерные массивы#Corner-case|Corner-case]]
>     - [[#Двумерные массивы#Case study: представление матрицы|Case study: представление матрицы]]
> - [[#Проектирование матрицы|Проектирование матрицы]]
>     - [[#Проектирование матрицы#Конструкторы|Конструкторы]]
>     - [[#Проектирование матрицы#Статические методы и друзья|Статические методы и друзья]]
>     - [[#Проектирование матрицы#Диаграмма возможностей|Диаграмма возможностей]]
>     - [[#Проектирование матрицы#Обсуждение: дружба - это магия|Обсуждение: дружба - это магия]]
>     - Конструкторы
>     - [[#Проектирование матрицы#Большая пятёрка|Большая пятёрка]]
>     - [[#Проектирование матрицы#Тизер: аннотация noexcept|Тизер: аннотация noexcept]]
>     - [[#Проектирование матрицы#Селекторы|Селекторы]]
>     - [[#Проектирование матрицы#Удобные методы|Удобные методы]]
>     - [[#Проектирование матрицы#Индексаторы|Индексаторы]]
>     - Удобные методы
>     - [[#Проектирование матрицы#Прокси-объекты|Прокси-объекты]]
>     - [[#Проектирование матрицы#Домашняя работа HWMX|Домашняя работа HWMX]]
>     - [[#Проектирование матрицы#Идея unique_ptr|Идея unique_ptr]]
>     - [[#Проектирование матрицы#Передача за scope|Передача за scope]]
>     - [[#Проектирование матрицы#Удобное создание|Удобное создание]]
>     - [[#Проектирование матрицы#Литература|Литература]]
...
Про rvalue-ref:
![[_Meta/attachments/Базовый курс/L04/4.1.png]]Про std::move:
![[_Meta/attachments/Базовый курс/L04/4.2.png]]
Пример с гита:
```cpp
//---------------------------------------------------------------------------
//
...
Одномерный массив:
![[_Meta/attachments/Базовый курс/L04/4.3.png]]
Двумерный массив?
![[_Meta/attachments/Базовый курс/L04/4.4.png]]
...
```
![[_Meta/attachments/Базовый курс/L04/4.5.png]]
#### Обсуждение
...
![[_Meta/attachments/Базовый курс/L04/4.6.png]]
#### Двумерные массивы
• Непрерывный массив
```c
int cont[10][10];
...
![[_Meta/attachments/Базовый курс/L04/4.7.png]]
#### Конструкторы
```cpp
template <typename T> class Matrix {
	// некое представление
