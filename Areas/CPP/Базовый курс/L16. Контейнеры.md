...
>     - [[#Последовательные контейнеры#Последовательные контейнеры|Последовательные контейнеры]]
>     - [[#Последовательные контейнеры#Что может смущать в этом коде?|Что может смущать в этом коде?]]
>     - [[#Последовательные контейнеры#Рассмотрим deque вместо vector*|Рассмотрим deque вместо vector*]]
>     - [[#Последовательные контейнеры#Деки против векторов|Деки против векторов]]
>     - [[#Последовательные контейнеры#Вектора|Вектора]]
>     - [[#Последовательные контейнеры#Деки|Деки]]
>     - [[#Последовательные контейнеры#Узловые контейнеры|Узловые контейнеры]]
>     - [[#Последовательные контейнеры#Особая возможность списков: сплайс|Особая возможность списков: сплайс]]
>     - [[#Последовательные контейнеры#Сплайс для списков: простая форма|Сплайс для списков: простая форма]]
>     - [[#Последовательные контейнеры#Сплайс для списков: сложная форма|Сплайс для списков: сложная форма]]
>     - [[#Последовательные контейнеры#Сплайс для списков: средняя форма|Сплайс для списков: средняя форма]]
>     - [[#Последовательные контейнеры#Идея контейнерных адаптеров|Идея контейнерных адаптеров]]
>     - [[#Последовательные контейнеры#Виды адаптеров|Виды адаптеров]]
>     - [[#Последовательные контейнеры#Case study: алгоритм Прима|Case study: алгоритм Прима]]
>     - [[#Последовательные контейнеры#Защита от ортогональности|Защита от ортогональности]]
>     - [[#Последовательные контейнеры#Недостаточная ортогональность|Недостаточная ортогональность]]
> - [[#Контейнеро-подобные классы|Контейнеро-подобные классы]]
>     - [[#Контейнеро-подобные классы#Коротко о битовых массивах|Коротко о битовых массивах]]
>     - [[#Контейнеро-подобные классы#Обсуждение: поговорим о строках|Обсуждение: поговорим о строках]]
>     - [[#Контейнеро-подобные классы#Строки: базовая функциональность|Строки: базовая функциональность]]
>     - [[#Контейнеро-подобные классы#Шаблон класса строки|Шаблон класса строки]]
>     - [[#Контейнеро-подобные классы#Характеристики типов|Характеристики типов]]
>     - [[#Контейнеро-подобные классы#Аллокаторы|Аллокаторы]]
>     - [[#Контейнеро-подобные классы#Поиск в строках|Поиск в строках]]
>     - [[#Контейнеро-подобные классы#Проблема статических строк|Проблема статических строк]]
>     - [[#Контейнеро-подобные классы#Решение: string_view(C++17)|Решение: string_view(C++17)]]
>     - [[#Контейнеро-подобные классы#Базовые операции над string_view|Базовые операции над string_view]]
>     - [[#Контейнеро-подобные классы#Views: идея для span (C++20)|Views: идея для span (C++20)]]
> - [[#Ассоциативные контейнеры|Ассоциативные контейнеры]]
>     - [[#Ассоциативные контейнеры#Смысл ассоциативности|Смысл ассоциативности]]
>     - [[#Ассоциативные контейнеры#Ассоциативный массив|Ассоциативный массив]]
>     - [[#Ассоциативные контейнеры#Обсуждение: собственный ключ|Обсуждение: собственный ключ]]
>     - [[#Ассоциативные контейнеры#Собственный hash|Собственный hash]]
>     - [[#Ассоциативные контейнеры#Представление в памяти*|Представление в памяти*]]
>     - [[#Ассоциативные контейнеры#Низкоуровневая информация|Низкоуровневая информация]]
>     - [[#Ассоциативные контейнеры#Рехэш|Рехэш]]
>     - [[#Ассоциативные контейнеры#Резервирование памяти|Резервирование памяти]]
>     - [[#Ассоциативные контейнеры#Два вида итерации|Два вида итерации]]
>     - [[#Ассоциативные контейнеры#Представление в памяти|Представление в памяти]]
>     - [[#Ассоциативные контейнеры#Обсуждение: отказ от хранения|Обсуждение: отказ от хранения]]
>     - [[#Ассоциативные контейнеры#Первая идея: node_map|Первая идея: node_map]]
>     - [[#Ассоциативные контейнеры#Интермедия: алгоритмический базис|Интермедия: алгоритмический базис]]
>     - [[#Ассоциативные контейнеры#Вторая идея: flat map|Вторая идея: flat map]]
>     - [[#Ассоциативные контейнеры#Загадочные квадратные скобки|Загадочные квадратные скобки]]
>     - [[#Ассоциативные контейнеры#Кстати о квадратных скобках|Кстати о квадратных скобках]]
>     - [[#Ассоциативные контейнеры#Неупорядоченные множества|Неупорядоченные множества]]
>     - [[#Ассоциативные контейнеры#Case study: орбита в группе|Case study: орбита в группе]]
> - [[#Упорядоченные контейнеры|Упорядоченные контейнеры]]
>     - [[#Упорядоченные контейнеры#Уникальность элементов|Уникальность элементов]]
>     - [[#Упорядоченные контейнеры#Порядок сравнения|Порядок сравнения]]
>     - [[#Упорядоченные контейнеры#Требования к предикату сравнения|Требования к предикату сравнения]]
>     - [[#Упорядоченные контейнеры#Контрпример Майерса|Контрпример Майерса]]
>     - [[#Упорядоченные контейнеры#Обсуждение: удаление|Обсуждение: удаление]]
>     - [[#Упорядоченные контейнеры#Не стреляйте себе в ногу через erase|Не стреляйте себе в ногу через erase]]
>     - [[#Упорядоченные контейнеры#Литература|Литература]]
...
![[_Meta/attachments/Базовый курс/L16/16.1.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.2.png]]
#### Особая возможность списков: сплайс
![[_Meta/attachments/Базовый курс/L16/16.3.png]]
...
```
![[_Meta/attachments/Базовый курс/L16/16.4.png]]
...
```
![[_Meta/attachments/Базовый курс/L16/16.5.png]]
...
```
![[_Meta/attachments/Базовый курс/L16/16.6.png]]
#### Обсуждение
• Какие вы видите применения спискам?
#### Идея контейнерных адаптеров
![[_Meta/attachments/Базовый курс/L16/16.7.png]]
#### Виды адаптеров
...
```
![[_Meta/attachments/Базовый курс/L16/16.8.png]]
...
assert(hpos == std::string::npos);
```
![[_Meta/attachments/Базовый курс/L16/16.9.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.10.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.11.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.12.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.13.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.14.png]]
...
![[_Meta/attachments/Базовый курс/L16/16.15.png]]
