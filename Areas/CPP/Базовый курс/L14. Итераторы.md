...
> [!abstract]- Оглавление
> - [[#Простые прикладные итераторы|Простые прикладные итераторы]]
>     - [[#Простые прикладные итераторы#Первый пример: обход вектора|Первый пример: обход вектора]]
>     - [[#Простые прикладные итераторы#Обобщение подхода|Обобщение подхода]]
>     - [[#Простые прикладные итераторы#Range-based обход|Range-based обход]]
>     - [[#Простые прикладные итераторы#Требования к range-based обходу|Требования к range-based обходу]]
>     - [[#Простые прикладные итераторы#Указатели как итераторы|Указатели как итераторы]]
>     - [[#Простые прикладные итераторы#Свойства указателей|Свойства указателей]]
>     - [[#Простые прикладные итераторы#Output итераторы|Output итераторы]]
>     - [[#Простые прикладные итераторы#Input итераторы|Input итераторы]]
>     - [[#Простые прикладные итераторы#Forward итераторы|Forward итераторы]]
>     - [[#Простые прикладные итераторы#Bidirectional итераторы|Bidirectional итераторы]]
>     - [[#Простые прикладные итераторы#Random-access итераторы|Random-access итераторы]]
>     - [[#Простые прикладные итераторы#Итераторы: дело в асимптотике|Итераторы: дело в асимптотике]]
>     - [[#Простые прикладные итераторы#Обсуждение: используйте итераторы|Обсуждение: используйте итераторы]]
>     - [[#Простые прикладные итераторы#Определение категории итераторов|Определение категории итераторов]]
>     - [[#Простые прикладные итераторы#Перегрузка по тегу|Перегрузка по тегу]]
>     - [[#Простые прикладные итераторы#Проверка категории|Проверка категории]]
>     - [[#Простые прикладные итераторы#Интерлюдия: conditional_type|Интерлюдия: conditional_type]]
>     - [[#Простые прикладные итераторы#Условный тип|Условный тип]]
>     - [[#Простые прикладные итераторы#ENABLE_IF|ENABLE_IF]]
>     - Проверка категории
>     - [[#Простые прикладные итераторы#Case study: пишем свой итератор|Case study: пишем свой итератор]]
>     - [[#Простые прикладные итераторы#Пишем свой итератор: подготовка|Пишем свой итератор: подготовка]]
>     - [[#Простые прикладные итераторы#Пишем свой итератор: тело|Пишем свой итератор: тело]]
>     - [[#Простые прикладные итераторы#Пишем свой итератор: первые шаги|Пишем свой итератор: первые шаги]]
>     - [[#Простые прикладные итераторы#Простые вещи|Простые вещи]]
>     - [[#Простые прикладные итераторы#Базовый интерфейс|Базовый интерфейс]]
>     - [[#Простые прикладные итераторы#Всегда пользуйтесь traits|Всегда пользуйтесь traits]]
>     - [[#Простые прикладные итераторы#Настоящая проблема: стрелочка|Настоящая проблема: стрелочка]]
>     - [[#Простые прикладные итераторы#Некоторые дурацкие способы|Некоторые дурацкие способы]]
>     - [[#Простые прикладные итераторы#Изящное решение: прокси-класс|Изящное решение: прокси-класс]]
> - [[#Преобразования и адаптеры|Преобразования и адаптеры]]
>     - [[#Преобразования и адаптеры#Направления и константность|Направления и константность]]
>     - [[#Преобразования и адаптеры#Пример обратных итераторов|Пример обратных итераторов]]
>     - [[#Преобразования и адаптеры#Преобразования указателей|Преобразования указателей]]
>     - [[#Преобразования и адаптеры#Диаграмма Майерса|Диаграмма Майерса]]
>     - [[#Преобразования и адаптеры#Предложение Майерса|Предложение Майерса]]
>     - [[#Преобразования и адаптеры#Трюк Хинанта|Трюк Хинанта]]
>     - [[#Преобразования и адаптеры#Переход к прямому итерированию|Переход к прямому итерированию]]
>     - [[#Преобразования и адаптеры#Адаптация: обратный range-based обход|Адаптация: обратный range-based обход]]
>     - [[#Преобразования и адаптеры#Реализация reverse_cont|Реализация reverse_cont]]
>     - [[#Преобразования и адаптеры#Адаптация: inserters|Адаптация: inserters]]
>     - [[#Преобразования и адаптеры#Виды адаптеров вставки для итераторов|Виды адаптеров вставки для итераторов]]
>     - [[#Преобразования и адаптеры#Пример: кросс-копирование|Пример: кросс-копирование]]
>     - [[#Преобразования и адаптеры#Простая задача: снова cross-copy|Простая задача: снова cross-copy]]
> - [[#Инвалидация|Инвалидация]]
>     - [[#Инвалидация#Валидность итераторов|Валидность итераторов]]
>     - [[#Инвалидация#Задача: валиден ли диапазон?|Задача: валиден ли диапазон?]]
>     - [[#Инвалидация#Сингулярные итераторы|Сингулярные итераторы]]
>     - [[#Инвалидация#Итераторы за границами диапазона|Итераторы за границами диапазона]]
>     - [[#Инвалидация#Инвалидация итераторов|Инвалидация итераторов]]
>     - [[#Инвалидация#Правила базовой инвалидации|Правила базовой инвалидации]]
>     - [[#Инвалидация#Использованные итераторы|Использованные итераторы]]
> - [[#Перемещающие итераторы|Перемещающие итераторы]]
>     - [[#Перемещающие итераторы#Библиотека std::filesystem|Библиотека std::filesystem]]
>     - [[#Перемещающие итераторы#Решение: создаём путь|Решение: создаём путь]]
>     - [[#Перемещающие итераторы#Итератор по содержимому директории|Итератор по содержимому директории]]
>     - [[#Перемещающие итераторы#Обход первого уровня: первый вариант|Обход первого уровня: первый вариант]]
>     - [[#Перемещающие итераторы#Обход первого уровня: проблема|Обход первого уровня: проблема]]
>     - [[#Перемещающие итераторы#Некая двойственность|Некая двойственность]]
>     - [[#Перемещающие итераторы#Литература|Литература]]
...
• Константные:
	• `cont.cbegin()`
	• `cont.crbegin()`
![[_Meta/attachments/Базовый курс/L14/14.1.png]]
...
![[_Meta/attachments/Базовый курс/L14/14.2.png]]
...
#### Диаграмма Майерса
![[_Meta/attachments/Базовый курс/L14/14.3.png]]
...
3 4
```
![[_Meta/attachments/Базовый курс/L14/14.4.png]]
