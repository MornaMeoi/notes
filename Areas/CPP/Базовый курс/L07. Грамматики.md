...
> [!abstract]- Оглавление
> - [[#Регулярные выражения и автоматы|Регулярные выражения и автоматы]]
>     - [[#Регулярные выражения и автоматы#Алфавиты и строки|Алфавиты и строки]]
>     - [[#Регулярные выражения и автоматы#Формальные языки|Формальные языки]]
>     - [[#Регулярные выражения и автоматы#Задачи для формальных языков|Задачи для формальных языков]]
>     - [[#Регулярные выражения и автоматы#Регулярные выражения|Регулярные выражения]]
>     - [[#Регулярные выражения и автоматы#Расширенные регулярные выражения|Расширенные регулярные выражения]]
>     - [[#Регулярные выражения и автоматы#Регулярные выражения в C++|Регулярные выражения в C++]]
>     - [[#Регулярные выражения и автоматы#Конечные автоматы: ДКА|Конечные автоматы: ДКА]]
>     - [[#Регулярные выражения и автоматы#От регулярных выражений к автоматам|От регулярных выражений к автоматам]]
>     - [[#Регулярные выражения и автоматы#Конечные автоматы: НКА|Конечные автоматы: НКА]]
>     - [[#Регулярные выражения и автоматы#От НКА к ДКА|От НКА к ДКА]]
> - [[#Практика лексического анализа|Практика лексического анализа]]
>     - [[#Практика лексического анализа#Задача лексического анализа|Задача лексического анализа]]
>     - [[#Практика лексического анализа#FLEX|FLEX]]
>     - [[#Практика лексического анализа#FLEX: простой пример|FLEX: простой пример]]
>     - [[#Практика лексического анализа#FLEX: немного сложнее|FLEX: немного сложнее]]
> - [[#Грамматики|Грамматики]]
>     - [[#Грамматики#Грамматика регулярных выражений|Грамматика регулярных выражений]]
>     - [[#Грамматики#Грамматика|Грамматика]]
>     - [[#Грамматики#Контекстная свобода и зависимость|Контекстная свобода и зависимость]]
>     - [[#Грамматики#Автоматы с магазинной памятью|Автоматы с магазинной памятью]]
>     - [[#Грамматики#Вывод в грамматике|Вывод в грамматике]]
>     - [[#Грамматики#Грамматика: неоднозначность|Грамматика: неоднозначность]]
>     - [[#Грамматики#Грамматика: приоритеты операций|Грамматика: приоритеты операций]]
>     - [[#Грамматики#Таксономия L/R|Таксономия L/R]]
>     - [[#Грамматики#Нисходящий парсинг LL(k)|Нисходящий парсинг LL(k)]]
>     - [[#Грамматики#Рекурсивный спуск LL(k)|Рекурсивный спуск LL(k)]]
>     - [[#Грамматики#Обсуждение: LL(1)|Обсуждение: LL(1)]]
>     - [[#Грамматики#Ограничения на LL(1)|Ограничения на LL(1)]]
>     - [[#Грамматики#Построение FIRST / FOLLOW|Построение FIRST / FOLLOW]]
>     - [[#Грамматики#Таблица для LL(1) разбора|Таблица для LL(1) разбора]]
>     - [[#Грамматики#Dangling else|Dangling else]]
>     - [[#Грамматики#Более совершенные методы|Более совершенные методы]]
>     - [[#Грамматики#Восходящий парсинг LR(k)|Восходящий парсинг LR(k)]]
>     - [[#Грамматики#Восходящий парсинг LR|Восходящий парсинг LR]]
> - [[#Практика синтаксического анализа|Практика синтаксического анализа]]
>     - [[#Практика синтаксического анализа#Задача синтаксического анализа|Задача синтаксического анализа]]
>     - [[#Практика синтаксического анализа#BISON|BISON]]
>     - [[#Практика синтаксического анализа#BISON: простой пример|BISON: простой пример]]
>     - [[#Практика синтаксического анализа#Токены и нетерминалы|Токены и нетерминалы]]
>     - [[#Практика синтаксического анализа#Грамматические правила|Грамматические правила]]
>     - [[#Практика синтаксического анализа#Взаимодействие с лексером|Взаимодействие с лексером]]
>     - [[#Практика синтаксического анализа#Код лексера|Код лексера]]
>     - [[#Практика синтаксического анализа#Драйвер: связующее звено|Драйвер: связующее звено]]
>     - [[#Практика синтаксического анализа#Ошибки shift и reduce|Ошибки shift и reduce]]
>     - [[#Практика синтаксического анализа#BISON: семантические значения|BISON: семантические значения]]
>     - [[#Практика синтаксического анализа#Простая архитектура компилятора|Простая архитектура компилятора]]
>     - [[#Практика синтаксического анализа#Литература|Литература]]
...
![[_Meta/attachments/Базовый курс/L07/7.1.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.2.png]]
#### Конечные автоматы: НКА
• Есть два способа разрешить НКА.
![[_Meta/attachments/Базовый курс/L07/7.3.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.4.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.5.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.6.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.7.png]]
• Вторую продукцию можно выбрать как B → ab.
![[_Meta/attachments/Базовый курс/L07/7.8.png]]
• Вторую продукцию можно выбрать как B → a.
• Теперь на третьем шаге всё тоже будет успешно.
![[_Meta/attachments/Базовый курс/L07/7.9.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.10.png]]
...
![[_Meta/attachments/Базовый курс/L07/7.11.png]]
#### Обсуждение
...
![[_Meta/attachments/Базовый курс/L07/7.12.png]]
