...
>     - [[#Специализация и инстанцирование#Инстанцирование|Инстанцирование]]
>     - [[#Специализация и инстанцирование#Инстанцирование и специализация|Инстанцирование и специализация]]
>     - [[#Специализация и инстанцирование#Удаление специализаций|Удаление специализаций]]
>     - [[#Специализация и инстанцирование#Специализация по nontype параметрам|Специализация по nontype параметрам]]
>     - [[#Специализация и инстанцирование#Ленивость и энергичность|Ленивость и энергичность]]
>     - [[#Специализация и инстанцирование#Инстанцирование - ленивый процесс|Инстанцирование - ленивый процесс]]
>     - [[#Специализация и инстанцирование#Явное инстанцирование|Явное инстанцирование]]
>     - [[#Специализация и инстанцирование#Частичная специализация|Частичная специализация]]
>     - [[#Специализация и инстанцирование#Специализация для похожих типов|Специализация для похожих типов]]
>     - [[#Специализация и инстанцирование#Упрощение имён в специализациях|Упрощение имён в специализациях]]
>     - [[#Специализация и инстанцирование#Case study: unique_ptr|Case study: unique_ptr]]
>     - [[#Специализация и инстанцирование#Вспоминаем структуру unique_ptr|Вспоминаем структуру unique_ptr]]
>     - Частичная специализация
>     - [[#Специализация и инстанцирование#Нарушение LSP для шаблонов|Нарушение LSP для шаблонов]]
> - [[#Разрешение имён|Разрешение имён]]
>     - [[#Разрешение имён#Постановка проблемы|Постановка проблемы]]
>     - [[#Разрешение имён#Двухфазное разрешение имён|Двухфазное разрешение имён]]
>     - [[#Разрешение имён#Пример Вандерворда|Пример Вандерворда]]
>     - [[#Разрешение имён#Зависимые имена типов|Зависимые имена типов]]
>     - [[#Разрешение имён#Зависимые имена шаблонов|Зависимые имена шаблонов]]
> - [[#Вывод типов|Вывод типов]]
>     - [[#Вывод типов#Неуточнённые типы|Неуточнённые типы]]
>     - [[#Вывод типов#Уточнённые типы|Уточнённые типы]]
>     - [[#Вывод типов#Вывод конструкторами классов (C++17)|Вывод конструкторами классов (C++17)]]
>     - [[#Вывод типов#Проблема: вывод через косвенность|Проблема: вывод через косвенность]]
>     - [[#Вывод типов#Хинты для вывода (C++17)|Хинты для вывода (C++17)]]
>     - [[#Вывод типов#Вывод без конструктора|Вывод без конструктора]]
>     - [[#Вывод типов#Встречаем auto и decltype|Встречаем auto и decltype]]
>     - [[#Вывод типов#Категории выражений|Категории выражений]]
>     - [[#Вывод типов#Четыре формы decltype|Четыре формы decltype]]
>     - [[#Вывод типов#Проблема в C++11|Проблема в C++11]]
>     - [[#Вывод типов#Попытка решения|Попытка решения]]
>     - [[#Вывод типов#Решение для C++11|Решение для C++11]]
>     - [[#Вывод типов#Решение для C++14 и позднее|Решение для C++14 и позднее]]
>     - [[#Вывод типов#Use before deduction|Use before deduction]]
>     - [[#Вывод типов#Идиома for-auto|Идиома for-auto]]
>     - [[#Вывод типов#Обсуждение: AAA initializers|Обсуждение: AAA initializers]]
>     - [[#Вывод типов#Проблемы с AAA|Проблемы с AAA]]
> - [[#Свёртка и проброс ссылок|Свёртка и проброс ссылок]]
>     - [[#Свёртка и проброс ссылок#Вывод типов из ссылочных типов|Вывод типов из ссылочных типов]]
>     - [[#Свёртка и проброс ссылок#Правила свёртки ссылок|Правила свёртки ссылок]]
>     - [[#Свёртка и проброс ссылок#Универсальность ссылок|Универсальность ссылок]]
>     - [[#Свёртка и проброс ссылок#Небольшое уточнение|Небольшое уточнение]]
>     - [[#Свёртка и проброс ссылок#Неуниверсальные ссылки|Неуниверсальные ссылки]]
>     - [[#Свёртка и проброс ссылок#Идиома for-auto&&|Идиома for-auto&&]]
>     - [[#Свёртка и проброс ссылок#Обсуждение: AAARR|Обсуждение: AAARR]]
>     - [[#Свёртка и проброс ссылок#Прозрачная оболочка|Прозрачная оболочка]]
>     - [[#Свёртка и проброс ссылок#Знакомимся: decltype(auto)|Знакомимся: decltype(auto)]]
>     - Прозрачная оболочка
>     - [[#Свёртка и проброс ссылок#Снова прозрачная оболочка|Снова прозрачная оболочка]]
>     - [[#Свёртка и проброс ссылок#Чего бы нам хотелось|Чего бы нам хотелось]]
>     - [[#Свёртка и проброс ссылок#Решение: использовать std::forward|Решение: использовать std::forward]]
>     - [[#Свёртка и проброс ссылок#Обсуждение: emplace|Обсуждение: emplace]]
>     - [[#Свёртка и проброс ссылок#Литература|Литература]]
...
```
![[_Meta/attachments/Базовый курс/L12/12.1.png]]
Пример:
```cpp
#include <iostream>
