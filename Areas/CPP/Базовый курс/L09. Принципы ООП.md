...
> [!abstract]- Оглавление
> - [[#Проектирование и UML|Проектирование и UML]]
>     - [[#Проектирование и UML#Контексты и интерфейсы|Контексты и интерфейсы]]
>     - [[#Проектирование и UML#Контексты и инварианты|Контексты и инварианты]]
>     - [[#Проектирование и UML#Базовые понятия|Базовые понятия]]
>     - [[#Проектирование и UML#Обсуждение: проектирование|Обсуждение: проектирование]]
>     - [[#Проектирование и UML#Обсуждение: язык моделирования|Обсуждение: язык моделирования]]
>     - [[#Проектирование и UML#Отношения между классами и UML|Отношения между классами и UML]]
> - [[#Принципы SOLID|Принципы SOLID]]
>     - [[#Принципы SOLID#Пример плохого проектирования (SRP)|Пример плохого проектирования (SRP)]]
>     - [[#Принципы SOLID#Принцип единственной ответственности|Принцип единственной ответственности]]
>     - [[#Принципы SOLID#Гайдлайн: связность|Гайдлайн: связность]]
>     - [[#Принципы SOLID#Пример плохого проектирования (OCP)|Пример плохого проектирования (OCP)]]
>     - [[#Принципы SOLID#Принцип открытости и закрытости|Принцип открытости и закрытости]]
>     - [[#Принципы SOLID#Модель и концепция|Модель и концепция]]
>     - [[#Принципы SOLID#Parent reversal: вводим шаблоны|Parent reversal: вводим шаблоны]]
>     - [[#Принципы SOLID#Пример плохого проектирования (LSP)|Пример плохого проектирования (LSP)]]
>     - [[#Принципы SOLID#Принцип подстановки Лисков|Принцип подстановки Лисков]]
>     - [[#Принципы SOLID#Ковариантность|Ковариантность]]
>     - [[#Принципы SOLID#Инвариантность|Инвариантность]]
>     - [[#Принципы SOLID#Контравариантность|Контравариантность]]
>     - [[#Принципы SOLID#Пример плохого проектирование (ISP)|Пример плохого проектирование (ISP)]]
>     - [[#Принципы SOLID#Принцип разделения интерфейса|Принцип разделения интерфейса]]
>     - [[#Принципы SOLID#Пример плохого проектирования (DIP)|Пример плохого проектирования (DIP)]]
>     - [[#Принципы SOLID#Принцип инверсии зависимостей|Принцип инверсии зависимостей]]
> - [[#Правила хорошего кода|Правила хорошего кода]]
>     - [[#Правила хорошего кода#Гуманитарная составляющая|Гуманитарная составляющая]]
>     - [[#Правила хорошего кода#Хороший код|Хороший код]]
>     - [[#Правила хорошего кода#Пример плохого проектирования|Пример плохого проектирования]]
>     - [[#Правила хорошего кода#Закон "Деметры"|Закон "Деметры"]]
>     - [[#Правила хорошего кода#Аллегория закона "Деметры"|Аллегория закона "Деметры"]]
>     - Пример плохого проектирования
>     - [[#Правила хорошего кода#POLA: убираем удивительное|POLA: убираем удивительное]]
> - [[#Паттерны проектирования|Паттерны проектирования]]
>     - [[#Паттерны проектирования#Идея паттернов проектирования|Идея паттернов проектирования]]
>     - [[#Паттерны проектирования#Порождающие паттерны: обзор|Порождающие паттерны: обзор]]
>     - [[#Паттерны проектирования#Порождающие паттерны: синглтон|Порождающие паттерны: синглтон]]
>     - [[#Паттерны проектирования#Порождающие паттерны: строитель|Порождающие паттерны: строитель]]
>     - [[#Паттерны проектирования#Поведенческие паттерны: обзор (ч.1)|Поведенческие паттерны: обзор (ч.1)]]
>     - [[#Паттерны проектирования#Структурные паттерны: обзор|Структурные паттерны: обзор]]
>     - [[#Паттерны проектирования#Поведенческие паттерны: обзор (ч.2)|Поведенческие паттерны: обзор (ч.2)]]
>     - [[#Паттерны проектирования#Паттерн наблюдатель|Паттерн наблюдатель]]
>     - [[#Паттерны проектирования#Пример модели: целые числа|Пример модели: целые числа]]
>     - [[#Паттерны проектирования#Литература|Литература]]
>     - [[#Паттерны проектирования#Бонус: антипаттерны|Бонус: антипаттерны]]
...
![[_Meta/attachments/Базовый курс/L09/9.1.png]]
#### Пример плохого проектирования
