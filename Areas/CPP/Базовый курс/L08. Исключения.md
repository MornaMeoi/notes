...
status: todo
reread:
concepts: ["[[RAII]]", "[[Exception safety]]"]
---
...
>     - [[#Ошибки и исключения#Обработка ошибок в стиле C|Обработка ошибок в стиле C]]
>     - [[#Ошибки и исключения#Проблемы уже в C|Проблемы уже в C]]
>     - [[#Ошибки и исключения#Проблема в C++|Проблема в C++]]
>     - [[#Ошибки и исключения#Чем нам грозит эта ситуация?|Чем нам грозит эта ситуация?]]
>     - [[#Ошибки и исключения#Попытка решения: iostream style|Попытка решения: iostream style]]
>     - [[#Ошибки и исключения#Копирование и присваивание|Копирование и присваивание]]
>     - [[#Ошибки и исключения#Перегрузка операторов|Перегрузка операторов]]
>     - [[#Ошибки и исключения#Основная идея решения|Основная идея решения]]
>     - [[#Ошибки и исключения#Типы передачи управления|Типы передачи управления]]
>     - [[#Ошибки и исключения#Исключения|Исключения]]
>     - [[#Ошибки и исключения#Исключительные ситуации|Исключительные ситуации]]
>     - [[#Ошибки и исключения#Порождение ошибки|Порождение ошибки]]
>     - [[#Ошибки и исключения#Порождение исключения|Порождение исключения]]
>     - [[#Ошибки и исключения#Раскрутка стека|Раскрутка стека]]
>     - [[#Ошибки и исключения#Больше про throw|Больше про throw]]
>     - [[#Ошибки и исключения#Ловля исключений|Ловля исключений]]
>     - [[#Ошибки и исключения#Некоторые правила|Некоторые правила]]
>     - [[#Ошибки и исключения#Некоторые неприятности|Некоторые неприятности]]
>     - [[#Ошибки и исключения#Избегаем неприятностей|Избегаем неприятностей]]
>     - [[#Ошибки и исключения#Но как избежать самобытности?|Но как избежать самобытности?]]
>     - [[#Ошибки и исключения#Стандартные классы исключений|Стандартные классы исключений]]
>     - [[#Ошибки и исключения#Используем стандартные классы|Используем стандартные классы]]
>     - [[#Ошибки и исключения#Множественное наследование|Множественное наследование]]
>     - [[#Ошибки и исключения#Перехват всех исключений|Перехват всех исключений]]
>     - [[#Ошибки и исключения#Нейтральность|Нейтральность]]
>     - [[#Ошибки и исключения#Перевыброс|Перевыброс]]
>     - [[#Ошибки и исключения#Try-блоки уровня функций|Try-блоки уровня функций]]
>     - [[#Ошибки и исключения#Catch уровня функций|Catch уровня функций]]
>     - [[#Ошибки и исключения#Исключения для лучшего кода?|Исключения для лучшего кода?]]
> - [[#Гарантии безопасности|Гарантии безопасности]]
>     - [[#Гарантии безопасности#Вернёмся к исходной проблеме|Вернёмся к исходной проблеме]]
>     - [[#Гарантии безопасности#Пример Каргилла|Пример Каргилла]]
>     - [[#Гарантии безопасности#Безопасность относительно исключений|Безопасность относительно исключений]]
>     - [[#Гарантии безопасности#Гарантии безопасности|Гарантии безопасности]]
>     - [[#Гарантии безопасности#Безопасное копирование|Безопасное копирование]]
>     - [[#Гарантии безопасности#Теперь конструктор копирования|Теперь конструктор копирования]]
>     - [[#Гарантии безопасности#Оператор присваивания|Оператор присваивания]]
>     - [[#Гарантии безопасности#Оператор присваивания v2|Оператор присваивания v2]]
>     - [[#Гарантии безопасности#Внезапно swap|Внезапно swap]]
>     - [[#Гарантии безопасности#Интерлюдия: noexcept|Интерлюдия: noexcept]]
>     - [[#Гарантии безопасности#Оператор присваивания: линия Калба|Оператор присваивания: линия Калба]]
>     - [[#Гарантии безопасности#Подумаем про push?|Подумаем про push?]]
>     - [[#Гарантии безопасности#Kalb line|Kalb line]]
>     - [[#Гарантии безопасности#Условный noexcept|Условный noexcept]]
>     - [[#Гарантии безопасности#Оператор noexcept|Оператор noexcept]]
>     - [[#Гарантии безопасности#Оператор noexcept: альтернативы|Оператор noexcept: альтернативы]]
>     - [[#Гарантии безопасности#Оператор noexcept: детали|Оператор noexcept: детали]]
>     - [[#Гарантии безопасности#Обсуждение: noexcept(false)|Обсуждение: noexcept(false)]]
>     - [[#Гарантии безопасности#Извлечение из массива|Извлечение из массива]]
>     - [[#Гарантии безопасности#Внезапная проблема|Внезапная проблема]]
>     - [[#Гарантии безопасности#Извлечение из массива v2|Извлечение из массива v2]]
> - [[#Детали работы с памятью|Детали работы с памятью]]
>     - [[#Детали работы с памятью#Глобальные операторы|Глобальные операторы]]
>     - [[#Детали работы с памятью#Формы глобальных операторов|Формы глобальных операторов]]
>     - [[#Детали работы с памятью#Небросающий new|Небросающий new]]
>     - [[#Детали работы с памятью#Размещающий new|Размещающий new]]
>     - [[#Детали работы с памятью#Работа с размещающим new|Работа с размещающим new]]
>     - [[#Детали работы с памятью#Переопределение new и delete|Переопределение new и delete]]
>     - [[#Детали работы с памятью#Работа с пользовательским классом|Работа с пользовательским классом]]
>     - [[#Детали работы с памятью#Обсуждение (Stepanov assignment)|Обсуждение (Stepanov assignment)]]
> - [[#Проектирование с исключениями|Проектирование с исключениями]]
>     - [[#Проектирование с исключениями#Отделённая реализация|Отделённая реализация]]
>     - [[#Проектирование с исключениями#Правило для деструкторов|Правило для деструкторов]]
>     - [[#Проектирование с исключениями#Общий вывод и картинка|Общий вывод и картинка]]
>     - [[#Проектирование с исключениями#Первая проблема: константность|Первая проблема: константность]]
>     - [[#Проектирование с исключениями#Вторая проблема: линия Калба|Вторая проблема: линия Калба]]
>     - [[#Проектирование с исключениями#Решение|Решение]]
>     - [[#Проектирование с исключениями#Смещение линии Калба|Смещение линии Калба]]
>     - [[#Проектирование с исключениями#Литература|Литература]]
...
#### Раскрутка стека
![[_Meta/attachments/Базовый курс/L08/8.1.png]]
#### Больше про throw
...
![[_Meta/attachments/Базовый курс/L08/8.2.png]]
![[_Meta/attachments/Базовый курс/L08/8.3.png]]
#### Обсуждение
...
![[_Meta/attachments/Базовый курс/L08/8.4.png]]
#### Перевыброс
...
```
![[_Meta/attachments/Базовый курс/L08/8.5.png]]
#### Решение
