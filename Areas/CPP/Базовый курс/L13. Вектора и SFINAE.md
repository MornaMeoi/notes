...
> [!abstract]- Оглавление
> - [[#Вектора|Вектора]]
>     - [[#Вектора#От ручного выделения к векторам|От ручного выделения к векторам]]
>     - [[#Вектора#Два непростых вопроса|Два непростых вопроса]]
>     - [[#Вектора#Требования к элементам контейнеров|Требования к элементам контейнеров]]
>     - [[#Вектора#Гарантии непрерывности памяти|Гарантии непрерывности памяти]]
>     - [[#Вектора#Неприятное исключение: vector\<bool\>|Неприятное исключение: vector\<bool\>]]
>     - [[#Вектора#Задача: что можно здесь улучшить?|Задача: что можно здесь улучшить?]]
>     - [[#Вектора#Ответ: вектор не терпит халатности|Ответ: вектор не терпит халатности]]
>     - [[#Вектора#Ещё про size и capacity|Ещё про size и capacity]]
>     - [[#Вектора#Амортизация|Амортизация]]
>     - [[#Вектора#Амортизированная стоимость|Амортизированная стоимость]]
>     - [[#Вектора#Лучшая стратегия|Лучшая стратегия]]
>     - [[#Вектора#Дополнение: метод потенциала|Дополнение: метод потенциала]]
>     - [[#Вектора#Два механизма инициализации|Два механизма инициализации]]
>     - [[#Вектора#Списочная инициализация: вектора|Списочная инициализация: вектора]]
>     - [[#Вектора#То же для ваших контейнеров|То же для ваших контейнеров]]
>     - [[#Вектора#Просто правило для {}|Просто правило для {}]]
>     - [[#Вектора#Первое представление об итераторах|Первое представление об итераторах]]
>     - [[#Вектора#Абстракция указателя|Абстракция указателя]]
>     - [[#Вектора#Конструирование из итераторов|Конструирование из итераторов]]
> - [[#SFINAE|SFINAE]]
>     - [[#SFINAE#Обсуждение: провал подстановки|Обсуждение: провал подстановки]]
>     - [[#SFINAE#SFINAE|SFINAE]]
>     - [[#SFINAE#SFINAE и ошибки|SFINAE и ошибки]]
>     - [[#SFINAE#Интегральные константы|Интегральные константы]]
>     - [[#SFINAE#Истина и ложь для типов|Истина и ложь для типов]]
>     - [[#SFINAE#Равенство типов|Равенство типов]]
>     - [[#SFINAE#Определители и модификаторы|Определители и модификаторы]]
>     - [[#SFINAE#Четырнадцать категорий|Четырнадцать категорий]]
>     - [[#SFINAE#Свойства типов|Свойства типов]]
>     - [[#SFINAE#Обсуждение: std::copy|Обсуждение: std::copy]]
>     - [[#SFINAE#Решение проблемы std::copy|Решение проблемы std::copy]]
> - [[#Вариабельные шаблоны|Вариабельные шаблоны]]
>     - [[#Вариабельные шаблоны#Вариабельные шаблоны|Вариабельные шаблоны]]
>     - [[#Вариабельные шаблоны#Паттерны раскрытия|Паттерны раскрытия]]
>     - [[#Вариабельные шаблоны#Задача: раскрытие пачек|Задача: раскрытие пачек]]
>     - [[#Вариабельные шаблоны#Снова прозрачная оболочка|Снова прозрачная оболочка]]
>     - [[#Вариабельные шаблоны#Обсуждение: пробросим функцию?|Обсуждение: пробросим функцию?]]
>     - [[#Вариабельные шаблоны#Контейнеры тяжёлых классов|Контейнеры тяжёлых классов]]
>     - [[#Вариабельные шаблоны#Emplace|Emplace]]
>     - [[#Вариабельные шаблоны#Интерлюдия: шаблонные методы|Интерлюдия: шаблонные методы]]
>     - [[#Вариабельные шаблоны#Специализация шаблонных методов|Специализация шаблонных методов]]
>     - [[#Вариабельные шаблоны#Шаблонные методы против ООП|Шаблонные методы против ООП]]
>     - [[#Вариабельные шаблоны#void_t|void_t]]
>     - [[#Вариабельные шаблоны#Задача: зависимый тип|Задача: зависимый тип]]
>     - [[#Вариабельные шаблоны#Решение: void_t|Решение: void_t]]
>     - [[#Вариабельные шаблоны#Конструирование из итераторов|Конструирование из итераторов]]
>     - [[#Вариабельные шаблоны#Абстракция значения|Абстракция значения]]
>     - [[#Вариабельные шаблоны#Абстракция значения: declval|Абстракция значения: declval]]
>     - Конструирование из итераторов
> - [[#Графы|Графы]]
>     - [[#Графы#Представление графа|Представление графа]]
>     - [[#Графы#HWCG: представление графа|HWCG: представление графа]]
>     - [[#Графы#HWCG: формальная постановка|HWCG: формальная постановка]]
>     - [[#Графы#Литература|Литература]]
> - [[#Свёртки|Свёртки]]
>     - [[#Свёртки#Свёртки|Свёртки]]
>     - [[#Свёртки#Проблемы print_all|Проблемы print_all]]
>     - [[#Свёртки#Решение: функтор AddSpace|Решение: функтор AddSpace]]
>     - [[#Свёртки#Экзотические свёртки (самостоятельно)|Экзотические свёртки (самостоятельно)]]
...
![[_Meta/attachments/Базовый курс/L13/13.1.png]]
...
if(vi == v.end()) { что-то }
```
![[_Meta/attachments/Базовый курс/L13/13.2.png]]
