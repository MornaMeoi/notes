...
>     - [[#Приведение типов#Типы гораздо важнее в C++ чем в C|Типы гораздо важнее в C++ чем в C]]
>     - [[#Приведение типов#Приведение в стиле C++|Приведение в стиле C++]]
>     - [[#Приведение типов#Избегаем reinterpret_cast в C++20|Избегаем reinterpret_cast в C++20]]
>     - [[#Приведение типов#Static cast - это явное преобразование|Static cast - это явное преобразование]]
>     - [[#Приведение типов#Functional style cast в C++|Functional style cast в C++]]
>     - [[#Приведение типов#Особенности неявного поведения|Особенности неявного поведения]]
>     - [[#Приведение типов#Унарный плюс (positive hack)|Унарный плюс (positive hack)]]
> - [[#Операторы и цепочки|Операторы и цепочки]]
>     - [[#Операторы и цепочки#Ваши типы как встроенные|Ваши типы как встроенные]]
>     - [[#Операторы и цепочки#Общий синтаксис операторов|Общий синтаксис операторов]]
>     - [[#Операторы и цепочки#Функторы: постановка проблемы|Функторы: постановка проблемы]]
>     - [[#Операторы и цепочки#Функторы: первый вариант решения|Функторы: первый вариант решения]]
>     - [[#Операторы и цепочки#Функторы: перегрузка ()|Функторы: перегрузка ()]]
>     - [[#Операторы и цепочки#Идиома PImpl|Идиома PImpl]]
>     - [[#Операторы и цепочки#Проблема неполного типа|Проблема неполного типа]]
>     - [[#Операторы и цепочки#Как реально выглядит unique_ptr?|Как реально выглядит unique_ptr?]]
>     - [[#Операторы и цепочки#Дефолтный удалитель|Дефолтный удалитель]]
>     - [[#Операторы и цепочки#Решение: пользовательский делетер|Решение: пользовательский делетер]]
>     - [[#Операторы и цепочки#Обсуждение: unique void pointer|Обсуждение: unique void pointer]]
>     - [[#Операторы и цепочки#Тизер: влияние на размеры|Тизер: влияние на размеры]]
>     - [[#Операторы и цепочки#Источник названия языка|Источник названия языка]]
>     - [[#Операторы и цепочки#Обсуждение: немного джигитовки|Обсуждение: немного джигитовки]]
>     - [[#Операторы и цепочки#Цепочечные операторы|Цепочечные операторы]]
>     - [[#Операторы и цепочки#Определение через цепочки|Определение через цепочки]]
> - [[#Бинарные операторы|Бинарные операторы]]
>     - [[#Бинарные операторы#Неявные преобразования|Неявные преобразования]]
>     - [[#Бинарные операторы#Определение через цепочки|Определение через цепочки]]
>     - [[#Бинарные операторы#Призыв к осторожности|Призыв к осторожности]]
>     - [[#Бинарные операторы#Одна небольшая проблема|Одна небольшая проблема]]
>     - [[#Бинарные операторы#Сравнение для basic_string|Сравнение для basic_string]]
>     - [[#Бинарные операторы#Интермедия: невезучий сдвиг|Интермедия: невезучий сдвиг]]
>     - [[#Бинарные операторы#Проблемы определения через цепочки|Проблемы определения через цепочки]]
>     - [[#Бинарные операторы#Сравнения как бинарные операторы|Сравнения как бинарные операторы]]
>     - [[#Бинарные операторы#Равенство и эквивалентность|Равенство и эквивалентность]]
>     - [[#Бинарные операторы#Дву и три валентные сравнения|Дву и три валентные сравнения]]
>     - [[#Бинарные операторы#Spaceship operator|Spaceship operator]]
>     - [[#Бинарные операторы#Defaulted spaceship operator|Defaulted spaceship operator]]
> - [[#Экзотика|Экзотика]]
>     - [[#Экзотика#Взятие адреса|Взятие адреса]]
>     - [[#Экзотика#Ограничения|Ограничения]]
>     - [[#Экзотика#Указатели на методы классов|Указатели на методы классов]]
>     - [[#Экзотика#Волшебные свойства ->*|Волшебные свойства ->*]]
>     - [[#Экзотика#Оператор запятая|Оператор запятая]]
>     - [[#Экзотика#Интермедия: sequencing|Интермедия: sequencing]]
>     - [[#Экзотика#Что нельзя перегрузить|Что нельзя перегрузить]]
>     - [[#Экзотика#Что не следует перегружать|Что не следует перегружать]]
>     - [[#Экзотика#И это ещё не все|И это ещё не все]]
>     - [[#Экзотика#Литература|Литература]]
