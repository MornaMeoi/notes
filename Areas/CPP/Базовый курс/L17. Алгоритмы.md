...
> [!abstract]- Оглавление
> - [[#Функторы и состояние|Функторы и состояние]]
>     - [[#Функторы и состояние#Обсуждение: for each|Обсуждение: for each]]
>     - [[#Функторы и состояние#Идея функтора|Идея функтора]]
>     - [[#Функторы и состояние#Hello, lambda world|Hello, lambda world]]
>     - [[#Функторы и состояние#Убираем const|Убираем const]]
>     - [[#Функторы и состояние#Виды захвата|Виды захвата]]
>     - [[#Функторы и состояние#Захват в теле класса|Захват в теле класса]]
>     - [[#Функторы и состояние#Задача: локальный контекст|Задача: локальный контекст]]
>     - [[#Функторы и состояние#Решение: локальный контекст|Решение: локальный контекст]]
>     - [[#Функторы и состояние#Единая типизация замыканий|Единая типизация замыканий]]
>     - [[#Функторы и состояние#Снова захват в теле класса|Снова захват в теле класса]]
>     - [[#Функторы и состояние#Информация о конкретном типе|Информация о конкретном типе]]
>     - [[#Функторы и состояние#Case study: finally|Case study: finally]]
>     - [[#Функторы и состояние#Обсуждение: heap indirection|Обсуждение: heap indirection]]
>     - [[#Функторы и состояние#Предостережение|Предостережение]]
> - [[#Алгоритмы|Алгоритмы]]
>     - [[#Алгоритмы#Алгоритмы|Алгоритмы]]
>     - [[#Алгоритмы#Несколько примеров copy_x|Несколько примеров copy_x]]
>     - [[#Алгоритмы#Обсуждение: специализации циклов|Обсуждение: специализации циклов]]
>     - [[#Алгоритмы#Паттерны в коде: find_if|Паттерны в коде: find_if]]
>     - [[#Алгоритмы#Иногда и find_if много|Иногда и find_if много]]
>     - [[#Алгоритмы#Обсуждение: и это частая проблема|Обсуждение: и это частая проблема]]
>     - [[#Алгоритмы#Паттерны в коде: копирование|Паттерны в коде: копирование]]
>     - [[#Алгоритмы#Паттерны в коде: transform|Паттерны в коде: transform]]
>     - [[#Алгоритмы#Обусуждение: функция как предикат|Обусуждение: функция как предикат]]
>     - [[#Алгоритмы#Второй смысл transform|Второй смысл transform]]
>     - [[#Алгоритмы#Отличия в гарантиях|Отличия в гарантиях]]
>     - [[#Алгоритмы#Задача: кстати о чтении документации|Задача: кстати о чтении документации]]
>     - [[#Алгоритмы#Паттерны в коде: remove|Паттерны в коде: remove]]
>     - [[#Алгоритмы#Некоторая засада с remove|Некоторая засада с remove]]
>     - [[#Алгоритмы#Идиома erase-remove|Идиома erase-remove]]
>     - [[#Алгоритмы#Обсуждение: не только remove|Обсуждение: не только remove]]
>     - [[#Алгоритмы#Паттерны в коде: перемещение группы|Паттерны в коде: перемещение группы]]
>     - [[#Алгоритмы#Внезапно rotate|Внезапно rotate]]
>     - [[#Алгоритмы#Групповое перемещение - это rotate|Групповое перемещение - это rotate]]
>     - [[#Алгоритмы#Небольшая проблема|Небольшая проблема]]
>     - [[#Алгоритмы#Решение|Решение]]
>     - [[#Алгоритмы#Групповое перемещение элементов|Групповое перемещение элементов]]
>     - [[#Алгоритмы#Паттерны в коде: gather|Паттерны в коде: gather]]
>     - [[#Алгоритмы#Внезапно stable_partition|Внезапно stable_partition]]
>     - [[#Алгоритмы#Общий обзор|Общий обзор]]
> - [[#No raw loops|No raw loops]]
>     - [[#No raw loops#Программа Шона Парента|Программа Шона Парента]]
>     - [[#No raw loops#Пример вспомогательных циклов|Пример вспомогательных циклов]]
>     - [[#No raw loops#Сортировки и недосортировки|Сортировки и недосортировки]]
>     - [[#No raw loops#Бинарный поиск|Бинарный поиск]]
>     - [[#No raw loops#Поисковые алгоритмы|Поисковые алгоритмы]]
>     - [[#No raw loops#Вернёмся к панелям|Вернёмся к панелям]]
>     - [[#No raw loops#Немного более человечно|Немного более человечно]]
>     - [[#No raw loops#Внезапное переобувание|Внезапное переобувание]]
> - [[#Case study: группы перестановок|Case study: группы перестановок]]
>     - [[#Case study: группы перестановок#Циклические перестановки|Циклические перестановки]]
>     - [[#Case study: группы перестановок#От перестановок к циклической записи|От перестановок к циклической записи]]
>     - [[#Case study: группы перестановок#Области определения|Области определения]]
>     - От перестановок к циклической записи
>     - [[#Case study: группы перестановок#Применение перестановок|Применение перестановок]]
>     - [[#Case study: группы перестановок#Перемножение перестановок|Перемножение перестановок]]
...
![[_Meta/attachments/Базовый курс/L17/17.1.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.2.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.3.png]]
...
```
![[_Meta/attachments/Базовый курс/L17/17.4.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.5.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.6.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.7.png]]
• Три параметра:
	• начало группы **f, \*f == 3**
	• конец группы **l, \*l == 6**
...
![[_Meta/attachments/Базовый курс/L17/17.8.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.9.png]]
#### Решение
• Зато будет работать `rotate(p', f, l)`.
![[_Meta/attachments/Базовый курс/L17/17.10.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.11.png]]
...
![[_Meta/attachments/Базовый курс/L17/17.12.png]]
```cpp
gather(f, l, pt, p) ::=
...
![[_Meta/attachments/Базовый курс/L17/17.13.png]]
#### Вернёмся к панелям
