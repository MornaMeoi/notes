...
>     - [[#Наследование#Язык ParaCL|Язык ParaCL]]
>     - [[#Наследование#Синтаксические деревья|Синтаксические деревья]]
>     - [[#Наследование#Первая попытка: супер-узел|Первая попытка: супер-узел]]
>     - [[#Наследование#Вторая попытка: void pointers|Вторая попытка: void pointers]]
>     - [[#Наследование#Лучшее решение: поддержка в языке|Лучшее решение: поддержка в языке]]
>     - [[#Наследование#Открытое наследование|Открытое наследование]]
>     - [[#Наследование#Обсуждение: квадрат и прямоугольник|Обсуждение: квадрат и прямоугольник]]
>     - [[#Наследование#Принцип подстановки Лисков|Принцип подстановки Лисков]]
>     - [[#Наследование#Проблема срезки: первое приближение|Проблема срезки: первое приближение]]
>     - [[#Наследование#HWP: ParaCL FE + симулятор|HWP: ParaCL FE + симулятор]]
> - [[#Полиморфизм|Полиморфизм]]
>     - [[#Полиморфизм#Общий интерфейс|Общий интерфейс]]
>     - [[#Полиморфизм#Первая попытка: указатель на метод|Первая попытка: указатель на метод]]
>     - [[#Полиморфизм#Языкова поддержка: virtual|Языкова поддержка: virtual]]
>     - [[#Полиморфизм#Таблица виртуальных функций|Таблица виртуальных функций]]
>     - [[#Полиморфизм#Порядок конструирования|Порядок конструирования]]
>     - [[#Полиморфизм#Статический и динамический тип|Статический и динамический тип]]
>     - [[#Полиморфизм#Языковая поддержка: virtual|Языковая поддержка: virtual]]
>     - [[#Полиморфизм#Проблемы с overloading|Проблемы с overloading]]
>     - [[#Полиморфизм#Обсуждение: overload vs override|Обсуждение: overload vs override]]
>     - [[#Полиморфизм#Языковая поддержка: override|Языковая поддержка: override]]
>     - [[#Полиморфизм#Языковая поддержка: pure virtual|Языковая поддержка: pure virtual]]
>     - [[#Полиморфизм#Внезапная утечка памяти|Внезапная утечка памяти]]
>     - [[#Полиморфизм#Интерфейсные классы|Интерфейсные классы]]
>     - [[#Полиморфизм#Виртуальное копирование|Виртуальное копирование]]
>     - [[#Полиморфизм#Срезка возвращается|Срезка возвращается]]
>     - [[#Полиморфизм#Необходимость: virtual dtor|Необходимость: virtual dtor]]
>     - [[#Полиморфизм#Обсуждение: как теперь жить?|Обсуждение: как теперь жить?]]
>     - [[#Полиморфизм#Языкова поддержка: final|Языкова поддержка: final]]
>     - [[#Полиморфизм#Пишем правильно: четыре способа|Пишем правильно: четыре способа]]
>     - [[#Полиморфизм#Empty Base Class Optimizations|Empty Base Class Optimizations]]
>     - [[#Полиморфизм#EBCO и unique_pointer|EBCO и unique_pointer]]
>     - [[#Полиморфизм#Языкова поддержка: protected|Языкова поддержка: protected]]
>     - [[#Полиморфизм#Пишем правильно: <span style="color: blue;">два</span> способа|Пишем правильно: <span style="color: blue;">два</span> способа]]
>     - [[#Полиморфизм#Обсуждение: PVC|Обсуждение: PVC]]
>     - [[#Полиморфизм#Виртуальные функции в конструкторах|Виртуальные функции в конструкторах]]
>     - [[#Полиморфизм#Статическое и динамическое связывание|Статическое и динамическое связывание]]
>     - [[#Полиморфизм#Аргументы по умолчанию|Аргументы по умолчанию]]
>     - [[#Полиморфизм#Выход из положения: NVI (Non-Virtual Interface)|Выход из положения: NVI (Non-Virtual Interface)]]
>     - [[#Полиморфизм#Два полиморфизма|Два полиморфизма]]
>     - [[#Полиморфизм#Обсуждение: ограничения|Обсуждение: ограничения]]
>     - [[#Полиморфизм#Перегрузка виртуальных функций|Перегрузка виртуальных функций]]
>     - [[#Полиморфизм#Сокрытие имён|Сокрытие имён]]
>     - [[#Полиморфизм#Введение имён в область видимости|Введение имён в область видимости]]
>     - [[#Полиморфизм#Обсуждение: контроль доступа|Обсуждение: контроль доступа]]
>     - [[#Полиморфизм#Разновидности наследования|Разновидности наследования]]
>     - [[#Полиморфизм#Наследование по умолчанию|Наследование по умолчанию]]
>     - [[#Полиморфизм#Отношение part-of|Отношение part-of]]
>     - [[#Полиморфизм#EBCO и unique_pointer: private inh|EBCO и unique_pointer: private inh]]
>     - [[#Полиморфизм#Case study: MyArray|Case study: MyArray]]
>     - [[#Полиморфизм#Первая попытка: двойное включение|Первая попытка: двойное включение]]
> - [[#Множественное наследование|Множественное наследование]]
>     - [[#Множественное наследование#Множественное наследование|Множественное наследование]]
>     - [[#Множественное наследование#Решение: прокси-класс|Решение: прокси-класс]]
>     - [[#Множественное наследование#Обсуждение: сама идея сомнительна|Обсуждение: сама идея сомнительна]]
>     - [[#Множественное наследование#Ромбовидные схемы|Ромбовидные схемы]]
>     - [[#Множественное наследование#Проблемы ромбовидных схем|Проблемы ромбовидных схем]]
>     - [[#Множественное наследование#Виртуальные базовые классы|Виртуальные базовые классы]]
>     - Виртуальные базовые классы
>     - Виртуальные базовые классы
>     - [[#Множественное наследование#Списки инициализации|Списки инициализации]]
>     - [[#Множественное наследование#Case study: сложная диаграмма|Case study: сложная диаграмма]]
>     - [[#Множественное наследование#Проблема преобразований|Проблема преобразований]]
> - [[#RTTI|RTTI]]
>     - [[#RTTI#Runtime Type Information|Runtime Type Information]]
>     - [[#RTTI#Возможности typeid|Возможности typeid]]
>     - [[#RTTI#Возможности dynamic_cast|Возможности dynamic_cast]]
>     - [[#RTTI#Ограничения|Ограничения]]
>     - [[#RTTI#Поведение dynamic_cast при ошибке|Поведение dynamic_cast при ошибке]]
>     - [[#RTTI#Литература|Литература]]
...
```
![[_Meta/attachments/Базовый курс/L06/6.1.png]]
...
```
![[_Meta/attachments/Базовый курс/L06/6.2.png]]
...
```
![[_Meta/attachments/Базовый курс/L06/6.3.png]]
...
a_ref = b1; // b2 == ???
```
![[_Meta/attachments/Базовый курс/L06/6.4.png]]
Пример с гита:
```cpp
//---------------------------------------------------------------------------
//
...
![[_Meta/attachments/Базовый курс/L06/6.5.png]]
...
![[_Meta/attachments/Базовый курс/L06/6.6.png]]
...
```
![[_Meta/attachments/Базовый курс/L06/6.7.png]]
...
![[_Meta/attachments/Базовый курс/L06/6.8.png]]
...
![[_Meta/attachments/Базовый курс/L06/6.9.png]]
Ответ:
• V1: B1, V1
• V2: B4, B2, V2
• D1: D1
...
![[_Meta/attachments/Базовый курс/L06/6.10.png]]
```cpp
struct Base {};
...
![[_Meta/attachments/Базовый курс/L06/6.11.png]]
```cpp
struct B1 {};
struct B2 {};
struct D : B1, B2 {};
