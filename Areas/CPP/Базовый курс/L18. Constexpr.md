...
>     - [[#Метапрограммирование#Идея "рекурсивного" раскрытия|Идея "рекурсивного" раскрытия]]
>     - [[#Метапрограммирование#Открытие метапрограммирования|Открытие метапрограммирования]]
>     - [[#Метапрограммирование#Факториал|Факториал]]
>     - [[#Метапрограммирование#Числа Фибоначчи|Числа Фибоначчи]]
>     - [[#Метапрограммирование#Две модели вычислений|Две модели вычислений]]
>     - [[#Метапрограммирование#Целочисленный квадратный корень|Целочисленный квадратный корень]]
>     - [[#Метапрограммирование#Условный тип|Условный тип]]
>     - Целочисленный квадратный корень
>     - [[#Метапрограммирование#Квадранты вычислений|Квадранты вычислений]]
> - [[#Constexpr функции|Constexpr функции]]
>     - [[#Constexpr функции#Константность|Константность]]
>     - [[#Constexpr функции#Что известно на этапе компиляции|Что известно на этапе компиляции]]
>     - [[#Constexpr функции#Ограничение на constexpr переменные|Ограничение на constexpr переменные]]
>     - [[#Constexpr функции#CONSTEXPR означает CONST?|CONSTEXPR означает CONST?]]
>     - [[#Constexpr функции#C++17: constexpr control flow|C++17: constexpr control flow]]
>     - [[#Constexpr функции#Некоторые альтернативы SFINAE|Некоторые альтернативы SFINAE]]
>     - [[#Constexpr функции#If constexpr для вариабельных шаблонов|If constexpr для вариабельных шаблонов]]
>     - [[#Constexpr функции#Снова о метапрограммах|Снова о метапрограммах]]
>     - [[#Constexpr функции#Ограничения в C++14|Ограничения в C++14]]
>     - [[#Constexpr функции#Пример: целочисленный логарифм|Пример: целочисленный логарифм]]
>     - [[#Constexpr функции#Не всегда constexpr|Не всегда constexpr]]
>     - [[#Constexpr функции#C++20, введение consteval и constinit|C++20, введение consteval и constinit]]
>     - [[#Constexpr функции#Не везде constexpr|Не везде constexpr]]
> - [[#Мета-ООП|Мета-ООП]]
>     - [[#Мета-ООП#Пользовательские литеральные типы|Пользовательские литеральные типы]]
>     - [[#Мета-ООП#Арифметика|Арифметика]]
>     - [[#Мета-ООП#Пользовательский суффикс|Пользовательский суффикс]]
>     - [[#Мета-ООП#Внезапная проблема|Внезапная проблема]]
>     - [[#Мета-ООП#Небольшая метапрограмма|Небольшая метапрограмма]]
>     - [[#Мета-ООП#Ладно, это была шутка|Ладно, это была шутка]]
>     - [[#Мета-ООП#Constexpr all the things!|Constexpr all the things!]]
>     - [[#Мета-ООП#Case study: замена vector на array|Case study: замена vector на array]]
>     - [[#Мета-ООП#Index sequences|Index sequences]]
>     - [[#Мета-ООП#Переход от вектора к массиву|Переход от вектора к массиву]]
>     - [[#Мета-ООП#C++20: constexpr vector и string!|C++20: constexpr vector и string!]]
>     - [[#Мета-ООП#Core constant expression...|Core constant expression...]]
> - [[#Concepts|Concepts]]
>     - [[#Concepts#Пример: проверка равенства|Пример: проверка равенства]]
>     - [[#Concepts#Интересная идея|Интересная идея]]
>     - [[#Concepts#Загадочный distance|Загадочный distance]]
>     - [[#Concepts#Констрейнты|Констрейнты]]
>     - [[#Concepts#Полное покрытие|Полное покрытие]]
>     - [[#Concepts#Недостатки sfinae-constraints|Недостатки sfinae-constraints]]
>     - [[#Concepts#Сложные ограничения|Сложные ограничения]]
>     - [[#Concepts#Ещё лучше диагностика|Ещё лучше диагностика]]
>     - [[#Concepts#Главное отличие сложных ограничений|Главное отличие сложных ограничений]]
>     - [[#Concepts#Что проверяют сложные ограничения|Что проверяют сложные ограничения]]
>     - [[#Concepts#Пример: convertible_to|Пример: convertible_to]]
>     - [[#Concepts#Синтаксический сахар|Синтаксический сахар]]
>     - [[#Concepts#Концепты|Концепты]]
>     - [[#Concepts#Отношение subsumes|Отношение subsumes]]
>     - [[#Concepts#Теперь перегрузка работает|Теперь перегрузка работает]]
>     - [[#Concepts#Литература|Литература]]
>     - [[#Concepts#Внезапно for_each|Внезапно for_each]]
>     - [[#Concepts#Первое наблюдение: не требуется|Первое наблюдение: не требуется]]
>     - [[#Concepts#Концепт range: итератор и ограничитель|Концепт range: итератор и ограничитель]]
>     - [[#Concepts#Унаследованные концепты|Унаследованные концепты]]
>     - [[#Concepts#Концепт view: вид на диапазон|Концепт view: вид на диапазон]]
>     - [[#Concepts#Снова о квадратных отверстиях|Снова о квадратных отверстиях]]
>     - [[#Concepts#Попытка прославиться|Попытка прославиться]]
>     - [[#Concepts#Нам мешает энергичность|Нам мешает энергичность]]
>     - [[#Concepts#Но виды не слишком энергичны|Но виды не слишком энергичны]]
>     - [[#Concepts#Для заинтересовавшихся (про литературу)|Для заинтересовавшихся (про литературу)]]
...
```
![[_Meta/attachments/Базовый курс/L18/18.1.png]]
#### Факториал
