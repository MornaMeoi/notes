...
status: done
reread: "1"
concepts: ["[[Время жизни]]", "[[Инварианты]]"]
---
...
> [!abstract]- Оглавление
> - [[#Genesis: имена и объекты|Genesis: имена и объекты]]
>     - [[#Genesis: имена и объекты#Типы: value types & object types|Типы: value types & object types]]
>     - [[#Genesis: имена и объекты#Модель памяти в Си|Модель памяти в Си]]
>     - [[#Genesis: имена и объекты#Нулевые указатели|Нулевые указатели]]
>     - [[#Genesis: имена и объекты#Индексация указателей|Индексация указателей]]
>     - [[#Genesis: имена и объекты#Ссылки (lvalue references)|Ссылки (lvalue references)]]
>     - [[#Genesis: имена и объекты#Синтаксис ссылок|Синтаксис ссылок]]
>     - [[#Genesis: имена и объекты#Правила для ссылок|Правила для ссылок]]
>     - [[#Genesis: имена и объекты#Константность для ссылок|Константность для ссылок]]
>     - [[#Genesis: имена и объекты#Использование ссылок|Использование ссылок]]
>     - [[#Genesis: имена и объекты#Немного священных войн|Немного священных войн]]
> - [[#Вычислительная геометрия|Вычислительная геометрия]]
>     - [[#Вычислительная геометрия#Я просто хочу пересечь треугольники|Я просто хочу пересечь треугольники]]
>     - [[#Вычислительная геометрия#На что похоже решение?|На что похоже решение?]]
>     - [[#Вычислительная геометрия#Выделим предметную область|Выделим предметную область]]
>     - [[#Вычислительная геометрия#Cкетч: структура для точки|Cкетч: структура для точки]]
>     - [[#Вычислительная геометрия#Скетч: структура для линии|Скетч: структура для линии]]
>     - [[#Вычислительная геометрия#Скетч: конструктор для линии|Скетч: конструктор для линии]]
>     - [[#Вычислительная геометрия#Идея unit-тестов|Идея unit-тестов]]
>     - [[#Вычислительная геометрия#Идея общего алгоритма|Идея общего алгоритма]]
> - [[#Инкапсуляция|Инкапсуляция]]
>     - [[#Инкапсуляция#Case study: список|Case study: список]]
>     - [[#Инкапсуляция#Алгоритм Флойда|Алгоритм Флойда]]
>     - [[#Инкапсуляция#Case stude: список|Case stude: список]]
>     - [[#Инкапсуляция#Инварианты|Инварианты]]
>     - [[#Инкапсуляция#Инкапсуляция в языке C|Инкапсуляция в языке C]]
>     - [[#Инкапсуляция#Инкапсуляция в языке C++|Инкапсуляция в языке C++]]
>     - [[#Инкапсуляция#Обсуждение: инварианты и линейность|Обсуждение: инварианты и линейность]]
>     - [[#Инкапсуляция#Неконсистентное состояние|Неконсистентное состояние]]
>     - [[#Инкапсуляция#Обсуждение: ссылки|Обсуждение: ссылки]]
>     - [[#Инкапсуляция#Важное замечание|Важное замечание]]
>     - [[#Инкапсуляция#Конструкторы и деструкторы|Конструкторы и деструкторы]]
>     - [[#Инкапсуляция#Аллокация динамической памяти|Аллокация динамической памяти]]
>     - [[#Инкапсуляция#Семантика new и delete|Семантика new и delete]]
> - [[#Область видимости и время жизни|Область видимости и время жизни]]
>     - [[#Область видимости и время жизни#Время жизни|Время жизни]]
>     - [[#Область видимости и время жизни#Провисшие указатели|Провисшие указатели]]
>     - [[#Область видимости и время жизни#Провисшие ссылки|Провисшие ссылки]]
>     - [[#Область видимости и время жизни#Продление жизни|Продление жизни]]
>     - [[#Область видимости и время жизни#Жизнь временных объектов|Жизнь временных объектов]]
>     - [[#Область видимости и время жизни#Иногда временный объект не создаётся|Иногда временный объект не создаётся]]
>     - [[#Область видимости и время жизни#Decaying|Decaying]]
>     - [[#Область видимости и время жизни#Lvalue & rvalue|Lvalue & rvalue]]
>     - [[#Область видимости и время жизни#Ссылки и указатели на массивы|Ссылки и указатели на массивы]]
>     - [[#Область видимости и время жизни#Ссылки и cdecl|Ссылки и cdecl]]
>     - [[#Область видимости и время жизни#Борьба против cdecl: typedef|Борьба против cdecl: typedef]]
>     - [[#Область видимости и время жизни#Альтернатива typedef: using|Альтернатива typedef: using]]
>     - [[#Область видимости и время жизни#Домашняя работа HW3D|Домашняя работа HW3D]]
>     - [[#Область видимости и время жизни#Литература|Литература]]

## Genesis: имена и объекты
![[_Meta/attachments/Базовый курс/L02/2.1.png]]
#### Обсуждение
• Что такое тип?
...
#### Модель памяти в Си
![[_Meta/attachments/Базовый курс/L02/2.2.png]]
#### Нулевые указатели
...
![[_Meta/attachments/Базовый курс/L02/2.3.png]]
#### Синтаксис ссылок
...
assert(*xptr == 20);
```
![[_Meta/attachments/Базовый курс/L02/2.4.png]]
#### Правила для ссылок
...
![[_Meta/attachments/Базовый курс/L02/2.7.png]]
#### Обсуждение
...
![[_Meta/attachments/Базовый курс/L02/2.8.png]]
![[_Meta/attachments/Базовый курс/L02/2.9.png]]
#### Case stude: список
...
```
![[_Meta/attachments/Базовый курс/L02/2.10.png]]
#### Провисшие ссылки
...
arr = t; // fail
```
![[_Meta/attachments/Базовый курс/L02/2.11.png]]
