...
template<typename Iter, typename = void_t<decltype(*std::declval<Iter&>()),
...
• Но вектор уже спроектирован за нас.
• На чём бы потренироваться?
## Графы
#### Представление графа
...
flowchart TD
	...
	classDef c fill:#ccf7f7,stroke:#000,stroke-width:1.5px,color:#000
	class 1,2,3,4,5,6,7,8,9 c
```
